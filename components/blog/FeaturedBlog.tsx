    ...
    return (
        <section className="py-8">
            <div className="max-w-lg ">
                <p className="text-blue-600  text-xs py-2">RESOURCES & INSIGHTS</p>
                <h1 className="text-3xl font-bold py-2">Engineering Excellence at NexusCorp</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[3fr_1fr] gap-4 py-6">
                <div className="min-w-0 border border-gray-400 rounded-md grid grid-cols-1 sm:grid-cols-2 bg-white md:h-68 sm:h-64 gap-2">
                    ...
                    <div className="min-w-0 space-y-2 w-full p-3">
                ...
                <div className="min-w-0 border rounded-md py-4 px-4 text-sm text-gray-100 w-full sm:w-60 md:w-full lg:w-78 bg-[#0050CB] grid grid-cols-1 gap-2 pb-14">
