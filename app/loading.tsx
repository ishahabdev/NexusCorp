export default function Loading() {
  return (
    <section className="bg-blue-50 grid grid-cols-1 lg:grid-cols-12 gap-4 p-4">
      <aside className="hidden lg:block lg:col-span-3 animate-pulse border-r-2 px-4">
      ...
      <div className="col-span-1 lg:col-span-9 animate-pulse">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="h-8 sm:h-10 w-32 sm:w-56 rounded-md bg-gray-200" />
        ...
        {/* Doosra input */}
        <div className="h-4 w-full sm:w-80 rounded-md bg-gray-200 mb-8" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
          {/* Left Card */}
          <div className="bg-white rounded-xl p-3.5 h-96 sm:h-120 flex flex-col">
            {/* Header */}
            <div className="flex items-center justify-between mb-3.5">
              <div className="h-8 sm:h-9 w-32 sm:w-40 rounded-md bg-gray-200" />

              <div className="flex items-center gap-2">
                <div className="h-9 w-10 sm:h-10 sm:w-12 rounded-md bg-gray-200" />
                <div className="h-9 w-10 sm:h-10 sm:w-12 rounded-md bg-gray-200" />
              </div>
            </div>

            {/* Body */}
            <div className="h-64 sm:h-90 rounded-md bg-gray-200 mb-3.5" />
